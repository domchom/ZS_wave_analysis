...
class BaseGUI(tk.Tk):
    def __init__(self):
        ...
        self.kymograph_button.grid(row = 11, column = 3, padx = 10, sticky = 'E')
...
class KymographGUI(tk.Tk):
    def __init__(self):
        ...
        # make a default path
        self.folder_path.set('/Users/domchom/Documents/Bement_lab/Meeting_Notes:Slides/230726_committee-meeting/IT-Rho Data/to-analyze')
        self.file_path_button['command'] = self.get_folder_path
        self.file_path_button.grid(row = 0, column = 1, padx = 10, sticky = 'W')        
